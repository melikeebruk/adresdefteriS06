...
<form action="kaydet.php" method="POST">
	...
	<fieldset>
		...
		<input type="radio" name="cinsiyet" onClick="location.href='kadin.php'" value="kadin" id="kadin">
			<font face="Arial" size="3" color=#FFFFFF>
				<b>Kadın</b></font><br/>

	
		<input type="radio" name="cinsiyet" onClick="location.href='erkek.php'" value="erkek" id="erkek">
			<font face="Arial" size="3" color=#FFFFFF>
				<b>Erkek</b></font><br/>
	</fieldset><br/>
	...
	<input action="kaydet.php" method="POST" type="submit" name="kaydet" style="background:#0000FF; width: 90px; height: 40px; font-family: Arial Black; font-size: 16px; color: aliceblue" value="KAYDET">
