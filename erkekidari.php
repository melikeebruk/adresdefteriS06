...
<form action="erkekidarikaydet.php" method="POST">
	...
	<input action="erkekidarikaydet.php" method="POST" type="submit" name="kaydet" style="background:#0000FF; width: 90px; height: 40px; font-family: Arial Black; font-size: 16px; color: aliceblue" value="KAYDET">
	
	<a href="erkekidarilistele.php">
