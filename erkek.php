...
<form action="erkekkaydet.php" method="POST">
	...
	<fieldset>
		...
		<input type="radio" name="calismaturu" onClick="location.href='erkekakademik.php'" value="akademik" id="akademik">
			<font face="Arial" size="3" color=#FFFFFF>
				<b>Akademik Personel</b></font><br/>
     
		<input type="radio" name="calismaturu" onClick="location.href='erkekidari.php'" value="idari" id="idari">
			<font face="Arial" size="3" color=#FFFFFF>
				<b>İdari Personel</b></font><br/>
     
		<input type="radio" name="calismaturu" onClick="location.href='erkekdiger.php'" value="diger" id="diger">
			<font face="Arial" size="3" color=#FFFFFF>
				<b>Diğer</b></font><br/>
    </fieldset><br/>
	...
	<input action="erkekkaydet.php" method="POST" type="submit" name="kaydet" style="background:#0000FF; width: 90px; height: 40px; font-family: Arial Black; font-size: 16px; color: aliceblue" value="KAYDET">
	
	<a href="erkeklistele.php">
